            ...
            <div className="form-container">
                ...
                <form>
                    <fieldset>
                        ...
                        <input type="password" name="passwordRepeat" placeholder="Confirm Password" required className="common-txt-input"/>
                    </fieldset>
                    <fieldset>
                        <div className="legend-container">
                    ...
                    <button type="submit" className="button expanded">Save Changes</button>
                </form>
            </div>
        );
    }
