...
/***/ (function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1); //TODO: Use const?
	var ReactDOM = __webpack_require__(158);
	var AdminUserTable = __webpack_require__(159);
	...
	*/
	ReactDOM.render(React.createElement(AdminUserTable, null), document.getElementById('adminusertable'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var AdminUserTable = function (_React$Component) {
	    _inherits(AdminUserTable, _React$Component);

	    function AdminUserTable() {
	        _classCallCheck(this, AdminUserTable);

	        var _this = _possibleConstructorReturn(this, (AdminUserTable.__proto__ || Object.getPrototypeOf(AdminUserTable)).call(this));
	        ...
	        _this.state = { sortOrder: _this.SORT_ORDER.UNSORTED, pageNum: 1 }; // TODO: Isn't there a default initialState or something for this
	    ...
	    _createClass(AdminUserTable, [{
	        ...
	        value: function getUsers() {
	            ...
	            var successFunc = function successFunc(response) {
	                _this2.state.users = response.users; //TODO: PROBABLY WRONG
	                _this2.sort(_this2.SORT_METHOD.BY_EMAIL);
	            };
	            ...
	            var headerRow = _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    { className: 'cell', onClick: function onClick() {
	                            return _this4.sort(_this4.SORT_METHOD.BY_EMAIL);
	                        } },
	                    this.getHeaderRowString(this.SORT_METHOD.BY_EMAIL)
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'cell', onClick: function onClick() {
	                            return _this4.sort(_this4.SORT_METHOD.BY_ADDRESS_STREET_NO);
	                        } },
	                    this.getHeaderRowString(this.SORT_METHOD.BY_ADDRESS_STREET_NO)
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'cell', onClick: function onClick() {
	                            return _this4.sort(_this4.SORT_METHOD.BY_ADDRESS_STREET_NAME);
	                        } },
	                    this.getHeaderRowString(this.SORT_METHOD.BY_ADDRESS_STREET_NAME)
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'cell', onClick: function onClick() {
	                            return _this4.sort(_this4.SORT_METHOD.BY_ADDRESS_CITY);
	                        } },
	                    this.getHeaderRowString(this.SORT_METHOD.BY_ADDRESS_CITY)
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'cell', onClick: function onClick() {
	                            return _this4.sort(_this4.SORT_METHOD.BY_ADDRESS_STATE);
	                        } },
	                    this.getHeaderRowString(this.SORT_METHOD.BY_ADDRESS_STATE)
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'cell', onClick: function onClick() {
	                            return _this4.sort(_this4.SORT_METHOD.BY_ADDRESS_ZIP);
	                        } },
	                    this.getHeaderRowString(this.SORT_METHOD.BY_ADDRESS_ZIP)
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'cell', onClick: function onClick() {
	                            return _this4.sort(_this4.SORT_METHOD.BY_IS_ADMIN);
	                        } },
	                    this.getHeaderRowString(this.SORT_METHOD.BY_IS_ADMIN)
	                )
	            );
	            ...
	            for (var i = startPos; i <= endPos; i++) {
	                ...
	                var row = _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'cell' },
	                        this.state.users[i].address.streetNo
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'cell' },
	                        this.state.users[i].address.streetName
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'cell' },
	                        this.state.users[i].address.city
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'cell' },
	                        this.state.users[i].address.state
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'cell' },
	                        this.state.users[i].address.zip
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'cell' },
